...
function createPasswordCard(item) {
  ...
  `;
    const titleSpan = mustQueryElement(card, '.card-title');
    const showBtn = mustQueryElement(card, '.btn-show');
    const copyBtn = mustQueryElement(card, '.btn-copy');
    const editBtn = mustQueryElement(card, '.btn-edit');
    const deleteBtn = mustQueryElement(card, '.btn-delete');
    let hidden = true;
...
async function copyToClipboard(content, copyBtn) {
...
async function deletePasswordCard(item, card) {
...
function mustQueryElement(root, selector) {
